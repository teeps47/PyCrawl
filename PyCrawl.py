...
class Crawler():
    ...
    CrawlObject = Crawler(baseURL, searchString, depth, debug=False)
        #Create Crawler Object
    CrawlObject.startCrawl() #Starts web crawl, prints results if debug=True
    CrawlObjct.getResultURLList() #Returns final list of URLs
    """

    def __init__(self, baseURL, searchString, depth, debug=False):
        "Crawler Constructor"
    ...
    def depthCrawl(self, URL, depth):
        ...
        URL List.
        """
        if self.debug == True: print URL, depth
        ...
        if self.debug==True: print containsString
...
search_string = "SOPA"
#base_url = "http://www.reuters.com/article/2012/01/18/idUS309090140520120118"
TestCrawler = Crawler(base_url, search_string, 1, debug=True)
